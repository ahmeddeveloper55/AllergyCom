...
class searchGreenPage extends StatefulWidget {
  const searchGreenPage({Key? key}) : super(key: key);

  @override
  State<searchGreenPage> createState() => _searchGreenPageState();
}

class _searchGreenPageState extends State<searchGreenPage> {
  List<greenModel> _searchList = [];
  List<greenModel> _userList = [];
  TextEditingController controller = TextEditingController();
  @override
  void initState() {
    super.initState();
    final providermodel = Provider.of<greenProvider>(context, listen: false);
    providermodel.getAllGreenPlants(_userList);
  }
